-- ============================================================================
-- 10_ALERTS_NOTIFICATIONS.SQL — Alerts for Feed Optimization
-- ============================================================================
USE DATABASE AQUACULTURE_FEED;
USE SCHEMA APP;

-- Notification integration (email)
CREATE OR REPLACE NOTIFICATION INTEGRATION aws_vietnam_aquaculture_feed_EMAIL_INT
  TYPE = EMAIL
  ENABLED = TRUE
...
CREATE OR REPLACE ALERT APP.PERFORMANCE_ALERT
  ...
  SCHEDULE = '5 MINUTE'
  COMMENT = 'Feed Optimization performance below threshold'
IF (EXISTS (
...
THEN
  CALL SYSTEM$SEND_EMAIL(
    'aws_vietnam_aquaculture_feed_EMAIL_INT',
    '<YOUR_EMAIL>',
    '[ALERT] Feed Optimization: Feed Optimization performance below threshold',
    'Feed Optimization performance below threshold'
  );
...
THEN
  CALL SYSTEM$SEND_EMAIL(
    'aws_vietnam_aquaculture_feed_EMAIL_INT',
    '<YOUR_EMAIL>',
    '[ALERT] Feed Optimization: Anomalous pattern detected',
